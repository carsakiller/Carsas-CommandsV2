...
---@diagnostic disable: lowercase-global, unused-local, undefined-global
...
---@param is_new_save boolean If the world is new
...
---Called whenever a vehicle is spawned
...
---Called whenever a vehicle is despawned
...
---@param id number The vehicle_id **or** object_id of the component
...
---@return number ui_id The id to be used with other UI functions. UI elements that contain unique data MUST have their own ui_id. However, if you want to display the same label or popup for all players, you can re-use the same ui_id
...
---@param ui_id number The ui_id of the UI elements you want to remove
...
---@param ui_id number The ui_id you want to use for this object
...
---@param ui_id number The ui_id of the map object to remove
...
---@param ui_id number The ui_id to use for this label
...
---@param ui_id number The ui_id of this label
...
---@param ui_id number The ui_id to use for this line
---@param start_matrix matrix The starting matrix for the line
---@param end_matrix matrix The end matrix for the line
...
---@param ui_id number The ui_id of this line
...
---@param ui_id number The ui_id to use for this popup
...
---@param ui_id number The ui_id of the popup
...
---@param matrix matrix The matrix to spawn the location at. If the x, y, z of the matrix are 0, 0, 0, the location will be spawned at a random position in a random tile of the same type as this location's
...
---@return matrix matrix The spawn location matrix
---@return boolean is_success If the function succeeded
...
---@return table zone_list The table of active zones
---## Example zone_list:
---```
---{
---    [zone_index] = {
...
---@return table? addon_data The data of the addon
--- ## Example Addon Data
---```
---{
---    ["name"] = name, 
...
---@param location_index number The index of the location
---@return table? location_data The data on the location
---@return boolean is_success If the function succeeded
...
---@return table component_data The data on the component
---@return boolean is_success If the function succeeded
...
---@param matrix matrix The matrix to spawn the component at
---@param addon_index number The index of the addon that the location is a part of
---@param location_index number The index of the location that the component is a part of
---@param component_index number The index of the component
...
---@param matrix matrix The matrix position to spawn the vehicle at
...
---@return table player_list The table of player data
---## Example Player Data
---```
--- {
---     [3] = {
...
---@return matrix player_matrix The position of the player as a matrix
---@return boolean is_success If the function succeeded
...
---@param matrix matrix The new position of the player
---@return boolean is_success If the function succeeded
...
---Get the player's character_id
---@param peer_id peer_id The peer_id of the player to get the character_id of
...
---@return matrix matrix The position matrix
---@return boolean is_success If the function succeeded
...
---@param matrix matrix The matrix position the vehicle should be teleported to
---@return boolean is_success If the function succeeded
...
---@return table vehicle_data The data of the vehicle
---@return boolean is_success If the function succeeded
...
---@return table button_data The data of the button
---@return boolean is_success If the function succeeded
---## Example Button Data
---```
---{
...
---@return table sign_data The position of the sign as a table
---@return boolean is_success If the function succeeded
---## Example Sign Data
---```
---{
...
---@return table dial_data The data of the dial
---@return boolean is_success If the function succeeded
---## Example Dial Data
---```
---{
...
---@return table tank_data The data of the tank
---@return boolean is_success If the function succeeded
---## Example Tank Data
---```
---{
...
---@param vehicle_id vehicle_id The vehicle_id of the vehicle the hopper is a part of
---@param hopper_name string The name of the hopper
---@return table hopper_data The data of the hopper
---@return boolean is_success If the function succeeded
---## Example Hopper Data
---```
---{
...
---@param vehicle_id vehicle_id The vehicle_id of the vehicle the battery is a part of
---@param battery_name string The name of the battery
---@return table battery_data The data of the battery
---@return boolean is_success If the function succeeded
...
---@param vehicle_id vehicle_id The vehicle_id of the vehicle the weapon is a part of
---@param weapon_name string The name of the weapon
---@return table weapon_data The data of the weapon
---@return boolean is_success If the function succeeded
---## Example Weapon Data
---```
---{
...
---@param matrix matrix The matrix to spawn the object at
...
---@param matrix matrix The matrix position to spawn the fire at
...
---@param matrix matrix The matrix to spawn the explosion at
...
---@param matrix matrix The matrix position to spawn the character at
...
---@param matrix matrix The matrix to spawn the animal at
...
---@return matrix matrix The matrix of the object, includes rotation data
---@return boolean is_success If the function succeeded
...
---@param matrix matrix The matrix to apply to the object, includes rotation data
---@return boolean is_success If the function succeeded
...
---@return table character_data The data of this character
...
---@param money number The new amount of money
...
---@return table time The current time in-game
---## Example Time Data
---```
---{
---    ["hour"] = 24_hour,
---    ["minute"] = 60_minute,
---    ["daylight_factor"] = midday (0 - 1),
...
---@param matrix matrix The location to get the weather at
---@return table weather The weather at the location
...
---@param matrix matrix The start position to perform the search from
...
---@return matrix|nil matrix The position matrix of the tile
---@return boolean is_success If the function succeeded
...
---@param matrix matrix The position matrix to perform the search from
...
---@param matrix matrix The location of the tile to get info on
---@return table tile_data The data on the tile
---@return boolean is_success If the function succeeded
---## Example Tile Data
---```
---{
...
---@param matrix matrix The position matrix of the tile in question
...
---@param needle_matrix matrix The matrix to check wether it is in the zone
---@param zone_matrix matrix The zone to check against
...
---@param start_matrix matrix The matrix to start from
---@param end_matrix matrix The matrix to end at
---@return table path The path to get from start to finish
---## Example Path Data
---```
---{
---    [i] = {
...
---@param matrix matrix The destination matrix the character AI should be aiming for
...
---@return table target_data The character's target data
---## Example Target Data
---```
---{
...
---@param matrix2 matrix The matrix to multiply by
---@return matrix multiplied_matrix The result of multiplying the matrices
...
---@return matrix inverted_matrix The matrix, now inverted
...
---@return matrix transposed_matrix The matrix, now transposed
---@see https://en.wikipedia.org/wiki/Transpose
function matrix.transpose(matrix) return transposed_matrix end

---Get an identity matrix
---@return matrix identity_matrix The identity matrix
...
---@return matrix rotation_matrix A new matrix, rotated by the requested number of radians on the X axis
...
---@return matrix rotation_matrix A new matrix, rotated by the requested number of radians on the Y axis
...
---@return matrix rotation_matrix A new matrix, rotated by the requested number of radians on the Z axis
...
---@return matrix translated_matrix The new translated matrix
function matrix.translation(x, y, z) return translated_matrix end

---Get the x, y, z position from a matrix
---@param matrix matrix The matrix to extract the position values from
...
---@return matrix rotation The rotation matrix
